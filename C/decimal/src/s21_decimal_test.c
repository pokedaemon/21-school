...
START_TEST(s21_is_less_null) {
    ...
    value_1.bits[0] = 0;
    value_2.bits[0] = 0;
    ck_assert_int_eq(s21_is_less(value_1, value_2), S21_FALSE);
...
START_TEST(s21_is_less_normal) {
    ...
    for (int i = 1, j = 2; i < 50 || j < 51; i++, j++) {
        value_1.bits[0] = i;
        value_2.bits[0] = j;
        ck_assert_int_eq(s21_is_less(value_1, value_2), S21_TRUE);
        ck_assert_int_eq(s21_is_less(value_2, value_1), S21_FALSE);
    }
}
END_TEST
...
START_TEST(s21_is_less_or_equal_normal) {
    ...
    for (int i = 0, j = 1; i < 51 || j < 52; i++, j++) {
        value_1.bits[0] = i;
        value_2.bits[0] = j;
        ck_assert_int_eq(s21_is_less_or_equal(value_1, value_2), S21_TRUE);
    }
...
START_TEST(s21_is_less_or_equal_with_sign) {
    ...
    s21_set_sign(&value_2, 1);
    ck_assert_int_eq(s21_is_less_or_equal(value_1, value_2), S21_FALSE);
    s21_set_sign(&value_1, 1);
    ck_assert_int_eq(s21_is_less_or_equal(value_1, value_2), S21_TRUE);
    s21_delete_sign(&value_1);
    ck_assert_int_eq(s21_is_less_or_equal(value_1, value_2), S21_FALSE);
...
START_TEST(s21_is_greater_null) {
    ...
    value_1.bits[0] = 0;
    value_2.bits[0] = 0;
    ck_assert_int_eq(s21_is_greater(value_1, value_2), S21_FALSE);
    s21_set_sign(&value_2, 1);
    ck_assert_int_eq(s21_is_greater(value_1, value_2), S21_FALSE);
}
END_TEST
...
START_TEST(s21_is_greater_normal) {
    ...
    for (int i = 1, j = 2; i < 50 || j < 51; i++, j++) {
        ...
        value_2.bits[0] = j;
        ck_assert_int_eq(s21_is_greater(value_1, value_2), S21_FALSE);
        ck_assert_int_eq(s21_is_greater(value_2, value_1), S21_TRUE);
    }
}
END_TEST
...
START_TEST(s21_is_greater_negative) {
    ...
    s21_delete_sign(&value_1);
    s21_set_sign(&value_2, 1);
    ck_assert_int_eq(s21_is_greater(value_1, value_2), S21_TRUE);
}
END_TEST
...
START_TEST(s21_is_greater_or_equal_normal) {
    ...
    for (int i = 0, j = 1; i < 51 || j < 52; i++, j++) {
        value_1.bits[0] = i;
        value_2.bits[0] = j;
        ck_assert_int_eq(s21_is_greater_or_equal(value_1, value_2), S21_FALSE);
    }
    for (int i = 0, j = 0; i < 52 || j < 52; i++, j++) {
        value_1.bits[0] = i;
        value_2.bits[0] = j;
        ck_assert_int_eq(s21_is_greater_or_equal(value_1, value_2), S21_TRUE);
    }
}
END_TEST
...
START_TEST(s21_int_and_decimal_max) {
    ...
    ck_assert_int_eq(res, S21_CONVERT_ERROR);
}
END_TEST
...
START_TEST(s21_sub_inf) {
    ...
    ck_assert_uint_eq(res, S21_NEGATIVE_INF_REPORT);
}
END_TEST
...
START_TEST(s21_div_zero) {
    ...
    ck_assert_uint_eq(result1, S21_DIV_BY_ZERO);
    s21_set_sign(&value_2, 1);
    ck_assert_uint_eq(result1, S21_DIV_BY_ZERO);
}
END_TEST
...
START_TEST(s21_div_pos_over) {
    ...
    ck_assert_uint_eq(over, S21_POSITIVE_INF_REPORT);
    s21_set_sign(&value_1, 1);
    s21_set_sign(&value_2, 1);
    ck_assert_uint_eq(over, S21_POSITIVE_INF_REPORT);
}
...
START_TEST(s21_div_neg_over) {
    ...
    s21_set_sign(&value_1, 1);
    int over = s21_div(value_1, value_2, &result);
    ck_assert_uint_eq(over, S21_NEGATIVE_INF_REPORT);
    s21_delete_sign(&value_1);
    s21_set_sign(&value_2, 1);
    ck_assert_uint_eq(over, S21_NEGATIVE_INF_REPORT);
}
...
START_TEST(s21_mul_big_over) {
    ...
    s21_set_power(&value_2, 1);
    int res = s21_mul(value_1, value_2, &result);
    ck_assert_uint_eq(res, S21_POSITIVE_INF_REPORT);
}
END_TEST
...
START_TEST(s21_round_positive_integer) {
    ...
    ck_assert_int_eq(s21_result, S21_OK);
}
END_TEST
...
START_TEST(s21_round_null) {
    ...
    s21_decimal value = {0};
    int s21_result = s21_round(value, result);
    ck_assert_int_eq(s21_result, S21_CONVERT_ERROR);
}
END_TEST
...
START_TEST(s21_sum_error) {
    ...
    ck_assert_int_eq(res, S21_POSITIVE_INF_REPORT);
    s21_set_sign(&value_2, 1);
    s21_set_sign(&value_1, 1);
    memset(&result, 0, sizeof(s21_decimal));
    res = s21_add(value_1, value_2, &result);
    ck_assert_int_eq(res, S21_NEGATIVE_INF_REPORT);
}
END_TEST
...
START_TEST(s21_decimal_float_error) {
    ...
    ck_assert_uint_eq(res, S21_CONVERT_ERROR);
}
END_TEST
